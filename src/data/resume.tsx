...
export const DATA = {
  ...
  description:
  "I know your time is limited, and your colleagues might be calling you right now, but I insist and risk my time not to bore you! \n\n\nMy Name is Rocky, and unlike most 'Virtual Assistants,' I'm not going to take money from you.",
  
  summary:
  " If you need a helping hand, with regards to your online business, or to streamline task you need to do I can be a help for you.",

  yawa:
  "I want to do this by giving my time to you within 5 days, considering I only need to work 3 hours per day. I will do any job order you want, show you what skills I have, and make your life easier and better before you meet me. And yes, there is no agenda to get you to hire me and pay within that period. You do not need to every single time I talk to people, whether coaches, Content Creators, or Influencers. \n\n\nIt is always worth it. I can show you all kinds of virtual assistant tricks that you may not have experienced anywhere else. \n \n \n I spend my entire day doing administration work, serving people in some of the most competitive niches on the internet. The only thing you have to do is use the link below to get your Free 15 minutes with me.",
  avatarUrl: "/me.png",
  skills: [
    "React",
    "Next.js",
  ...
  contact: {
    ...
    social: {
      ...
      Youtube: {
        name: "Youtube",
        url: "https://https://www.youtube.com/@rhackz4290",
        icon: Icons.youtube,
        navbar: true,
      },
      email: {
